...
public class Q116_PopulatingNextRightPointersInEachNode {
    ...
    public static void main(String[] args){
        Q116_PopulatingNextRightPointersInEachNode solution = new Q116_PopulatingNextRightPointersInEachNode();

        // 注意使用内部类new对象的方式
        Q116_PopulatingNextRightPointersInEachNode.TreeLinkNode head = solution.new TreeLinkNode(1);
