...
import algorithm.util.NodeList;

public class LeetCode083_RemoveDupFromSortedList {
    public static void main(String[] args) {
        LeetCode083_RemoveDupFromSortedList solution = new LeetCode083_RemoveDupFromSortedList();
